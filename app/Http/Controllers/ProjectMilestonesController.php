...
class ProjectMilestonesController extends Controller
{
    ...
    public function all(Request $request)
    {
        ...
        if ($search_query != '') {
            ...
            $api_response = makeIntervalsApiCall(Auth::user()->intervals_api_key, 'GET', 'milestone/?' . $search_query);
        } else {

            $api_response = makeIntervalsApiCall(Auth::user()->intervals_api_key, 'GET', 'milestone/');
        }
